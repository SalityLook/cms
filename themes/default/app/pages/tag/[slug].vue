...
<template>
  <div class="max-w-5xl mx-auto px-4 sm:px-6 py-12 sm:py-16">
    <p class="text-sm font-semibold text-brand-600 dark:text-brand-400 uppercase tracking-wide mb-2">Tag</p>
    ...
    <p v-else class="text-slate-400 text-center py-16">Belum ada post dengan tag ini.</p>
  </div>
</template>
