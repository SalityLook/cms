...
export * from "./domain/oembed/index";
export * from "./domain/plugins/index";
...
import { PluginService } from "./domain/plugins/plugin-service";
...
import { TotpService } from "./domain/totp/totp-service";
...
export const pluginService = new PluginService(db);
export const oembedService = new OembedService(db);
